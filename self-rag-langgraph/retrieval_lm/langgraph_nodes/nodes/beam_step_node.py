...
def build_beam_step_node(
    ...
    Reads prediction_tree / levels / current_depth from state, expands all
    active beams by generating over all ctxs, scores them, prunes to
    beam_width, and increments current_depth.
    """
